...
const Register = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "role") {
      setShowNpmInput(value === "student" || value === "lecturer");
    ...
    <div className="flex justify-center items-center w-screen h-screen bg-[#e9ecef]">
      <div className="bg-white border-t-4 border-blue-600 rounded-b text-black px-4 py-3 shadow-md rounded-md w-80">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="py-2 w-full rounded-sm bg-[#28a745] hover:bg-green-700 text-center text-white font-medium text-sm mt-3"
          >
            Register
          </button>
        </form>
