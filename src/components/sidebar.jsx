        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            {isOpen && (
              <>
                <hr className="mb-3" />
                <span className="text-black font-medium">{`${first_name} ${last_name}`}</span>
              </>
            )}
            <hr className="mt-3" />
          </li>
            ...
            <>
              ...
              <li>
                <NavLink
                  ...
                  className="sidebar-item flex items-center p-2 text-black rounded-lg hover:bg-gray-200 group active:bg-blue-600 active:text-white"
                  current-page={
                    location.pathname === "/admin/pendaftaran"
                      ? "true"
                      : "false"
                  }
                >
              ...
              <li>
                <NavLink
                  ...
                  className="sidebar-item flex items-center p-2 text-black rounded-lg hover:bg-gray-200 group active:bg-blue-600 active:text-white"
                  current-page={
                    location.pathname === "/admin/skl" ? "true" : "false"
                  }
                >
                  <FontAwesomeIcon
                    icon={faFile}
                    className={`${isOpen ? "" : "p-3 mx-auto text-xl"} `}
                  />
                  {isOpen && <span className="ms-3">SKL</span>}
                </NavLink>
              </li>
              <li>
                <NavLink
                  ...
                  className="sidebar-item flex items-center p-2 text-black rounded-lg hover:bg-gray-200 group active:bg-blue-600 active:text-white"
                  current-page={
                    location.pathname === "/admin/calon-wisuda"
                      ? "true"
                      : "false"
                  }
                >
